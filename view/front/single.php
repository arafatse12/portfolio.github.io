                  ...
                  <div class="comment-list-wrapper">
                    <ul class="comment-list">
                      <li>
                        <div class="clearfix card">
                          <div class="left comment-img">
                            <a href="#"><img src="assets/front/images/cmt1.jpg" alt="">
                            </a>
                          </div>
                        ...
                        <ul class="comment-list">
                          <li>
                            <div class="clearfix card">
                              <div class="left comment-img">
                                <a href="#"><img src="assets/front/images/unknown.jpg" alt="">
                                </a>
                              </div>
                              <div class="card-content comment-content">
                                <div class="comment-meta">
                      ...
                      <li>
                        <div class="clearfix card">
                          <div class="left comment-img">
                            <a href="#"><img src="assets/front/images/cmt2.jpg" alt="">
                            </a>
                          </div>
                          <div class="card-content comment-content">
                            <div class="comment-meta">
            ...
            <div class="col-sm-4">
              <div class="primary-sidebar">
                <aside class="single-widget">
                  ...
                  <ul>
                    <li>
                      <a href="">The Image Post One</a>
                      <span>March 24, 2015</span>
                    </li>
                    <li>
                      <a href="">The Image Post Two</a>
                      <span>March 24, 2015</span>
                    </li>
                    <li>
                      <a href="">The Image Post Three</a>
                      <span>March 24, 2015</span>
                    </li>
                    <li>
                      <a href="">The Image Post Four</a>
                      <span>March 24, 2015</span>
                    </li>
                    <li>
                      <a href="">The Image Post Five</a>
                      <span>March 24, 2015</span>
                    </li>
                  </ul>
                </aside>
                ...
                <aside class="single-widget">
                  ...
                  <ul>
                    <li><a href="#">March 24, 2015</a>
                    </li>
                    <li><a href="#">April 24, 2015</a>
                    </li>
                    <li><a href="#">May 24, 2015</a>
                    </li>
                    <li><a href="#">June 24, 2015</a>
                    </li>
                    <li><a href="#">July 24, 2015</a>
                    </li>
                  </ul>
                </aside>
                <aside class="single-widget">
                  ...
                  <div class="widget-text">
                    <a href="#" class="tags">Art</a>
                    <a href="#" class="tags">Awesome</a>
                    <a href="#" class="tags">Style</a>
                    <a href="http://tinyurl.com/jdymnat" class="tags">Image</a>
                    <a href="#" class="tags">Design</a>
                    <a href="#" class="tags">Post</a>
                    <a href="#" class="tags">Three</a>
                    <a href="#" class="tags">Typhography</a>
                    <a href="#" class="tags">BDinfosys</a>
                  </div>
                </aside>
              </div>
            </div> <!-- ./sidebar end-->
